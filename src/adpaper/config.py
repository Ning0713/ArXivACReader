...
class SiteConfig:
    title: str = "Affective Computing Papers"
    subtitle: str = "Daily Affective Computing Research Digest"
    domain: str = "acpaper.ning0713.top"
    base_path: str = "/"
    output_dir: str = "site"
...
class SourceConfig:
    ...
    retries: int = 3
    user_agent: str = "ArXivACReader/0.1 (+https://github.com/Ning0713/ArXivACReader)"


@dataclass(slots=True)
class FilterConfig:
    plugin: str = "plugins.affective_computing:plugin"
